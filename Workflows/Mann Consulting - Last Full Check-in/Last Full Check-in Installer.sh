...
curl -sS -H "Authorization: Bearer $authorizationToken" "$jamfpro_url/JSSResource/categories" -H "Content-Type: application/xml" -X "POST" --data-binary "@./categories/Mann Consulting.xml"

echo "Uploading computerextensionattributes/Mann Consulting - Last Full Check-in.xml"
curl -sS -H "Authorization: Bearer $authorizationToken" "$jamfpro_url/JSSResource/computerextensionattributes" -H "Content-Type: application/xml" -X "POST" --data-binary "@./computerextensionattributes/Mann Consulting - Last Full Check-in.xml"

echo "Uploading computergroups/Mann Consulting - Last Full Check-in = Fail.xml"
curl -sS -H "Authorization: Bearer $authorizationToken" "$jamfpro_url/JSSResource/computergroups" -H "Content-Type: application/xml" -X "POST" --data-binary "@./computergroups/Mann Consulting - Last Full Check-in = Fail.xml"

echo "Uploading computergroups/Mann Consulting - Last Full Check-in = Pass.xml"
curl -sS -H "Authorization: Bearer $authorizationToken" "$jamfpro_url/JSSResource/computergroups" -H "Content-Type: application/xml" -X "POST" --data-binary "@./computergroups/Mann Consulting - Last Full Check-in = Pass.xml"

echo "Uploading policies/zzzz Mann Consulting - Policies Finished.xml"
curl -sS -H "Authorization: Bearer $authorizationToken" "$jamfpro_url/JSSResource/policies" -H "Content-Type: application/xml" -X "POST" --data-binary "@./policies/zzzz Mann Consulting - Policies Finished.xml"